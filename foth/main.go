...
func doInit(ev *eval.Eval, path string) error {
	...
	for err == nil {
		...
		if err != nil {
			...
			// This error is generated by the "QUIT" word, and
			// means there was an expected early-return.
			// It is an error condition that requires handling.
			if err == eval.ErrQuit {
				return nil
			}

			// OK a _real_ error was received.
			fmt.Printf("ERROR: %s\n", err.Error())
